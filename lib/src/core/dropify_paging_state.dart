...
/// Recommended caller-owned paging state for paginated Dropify widgets.
@immutable
final class DropifyPagingState<PageKey, T> extends PagingStateBase<PageKey, T> {
  ...
  /// The search query associated with this paging state.
  final String? search;

  /// The active cancellation token, when the caller uses one.
